...
const AdministracaoDashboardMobileFriendly: React.FC = () => {
  const {
    deviceType,
    isMobile,
    isTablet,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Alert variant="warning" className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1">
                    O último backup foi há 2 dias. Considere executar um backup
                    manual.
                  </p>
                </div>
              </Alert>
              ...
              <Alert variant="success" className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1">
                    Todas as atualizações de segurança foram aplicadas.
                  </p>
                </div>
              </Alert>
            </div>
            ...
            <div className="space-y-4">
              {systemLogs.map((log) => {
                ...
                return (
                  <div
                    key={log.id}
                    className="bg-white dark:bg-darkmode-600 rounded-lg p-4"
                  >
...
export default AdministracaoDashboardMobileFriendly;
